...
interface BlueCardProps extends CardProps { /** extend the default shadcn arguments */
...
export function BlueCard({
    ...
    return (
      <CardContent
        className={`flex items-center gap-3 rounded-2xl  p-6 w-fit ${className ?? ""}`}
        {...props}
      >
        <div className="flex flex-col gap-4">
  
          <div className="space-y-1"> 
            <CardTitle className="text-5xl font-bold tracking-tight text-slate-600">
              {value2058}
            </CardTitle>
...
export function RedCard({
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <div className="space-y-1">
          <CardTitle className="text-5xl font-bold tracking-tight text-[#FF928A]">
            {value2058}
          </CardTitle>
          <CardTitle className="text-base font-semibold text-[#FF928A]">
            Increases by&nbsp;2058
          </CardTitle>
          <CardDescription className="text-xs text-[#FF928A]">
            (End&nbsp;of&nbsp;Life) SSP1-2.6
          </CardDescription>
        </div>
